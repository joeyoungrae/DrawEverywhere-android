...
class SearchPostListFragment : BaseInnerFragment<FragmentSearchListBinding>() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        viewModel.postListByTitle.observe(viewLifecycleOwner) {
            adapter = PostAdapter(viewModel.postListByTitle.value!!, PostAdapter.ShowType.FAT_GIF, iopenPost, Glide.with(this))
